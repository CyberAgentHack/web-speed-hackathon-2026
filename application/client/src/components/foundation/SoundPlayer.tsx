...
export const SoundPlayer = ({ sound }: Props) => {
  ...
  const { data, isLoading } = useFetch(getSoundPath(sound.id), fetchBinary, isInView);
  ...
  return (
    <div
      ref={inViewRef}
      className="bg-cax-surface-subtle flex h-full min-h-[96px] w-full items-center justify-center"
    >
