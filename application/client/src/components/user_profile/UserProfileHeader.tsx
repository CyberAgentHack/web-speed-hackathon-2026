...
import { formatDateISO, formatDateLL } from "@web-speed-hackathon-2026/client/src/utils/date_format";
    ...
    <header className="relative">
      ...
      <div className="px-4 pt-20">
        ...
        <p className="text-cax-text-muted pt-2 text-sm">
          ...
          <span>
            <time dateTime={formatDateISO(user.createdAt)}>
              {formatDateLL(user.createdAt)}
            </time>
            からサービスを利用しています
          </span>
        </p>
