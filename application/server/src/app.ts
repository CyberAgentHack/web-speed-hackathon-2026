...
import { staticRouter } from "@web-speed-hackathon-2026/server/src/routes/static.ts";
import { createSessionMiddleware } from "@web-speed-hackathon-2026/server/src/session.ts";
