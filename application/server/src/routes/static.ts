...
// Fully static HTML for /terms page - no React bundle, zero TBT
function getTermsStaticHtml(): string {
  const fontFaceCSS = `<style>@font-face{font-family:"Rei no Are Mincho";src:url(/fonts/ReiNoAreMincho-Heavy.woff2) format("woff2");font-weight:bold;font-display:block}@font-face{font-family:"Rei no Are Mincho";src:url(/fonts/ReiNoAreMincho-Regular.woff2) format("woff2");font-weight:normal;font-display:block}.font-awesome{height:1em;vertical-align:-0.125em;width:1em}</style>`;
...
${fontFaceCSS}
<script>window.__BUILD_INFO__={BUILD_DATE:${JSON.stringify(process.env["BUILD_DATE"] || new Date().toISOString())},COMMIT_HASH:${JSON.stringify(process.env["SOURCE_VERSION"] || "")}};</script>
</head>
...
<nav class="border-cax-border bg-cax-surface fixed right-0 bottom-0 left-0 z-10 h-12 border-t lg:relative lg:h-full lg:w-48 lg:border-t-0 lg:border-r">
<div class="relative grid grid-flow-col items-center justify-evenly lg:fixed lg:flex lg:h-full lg:w-48 lg:flex-col lg:justify-between lg:p-2">
<ul class="grid grid-flow-col items-center justify-evenly lg:grid-flow-row lg:auto-rows-min lg:justify-start lg:gap-2">
<li><a class="flex flex-col items-center justify-center w-12 h-12 hover:bg-cax-brand-soft rounded-full sm:px-2 sm:w-24 sm:h-auto sm:rounded-sm lg:flex-row lg:justify-start lg:px-4 lg:py-2 lg:w-auto lg:h-auto lg:rounded-full" href="/"><span class="relative text-xl lg:pr-2 lg:text-3xl"><svg class="font-awesome inline-block fill-current leading-none"><use href="/sprites/font-awesome/solid.svg#home"></use></svg></span><span class="hidden sm:inline sm:text-sm lg:text-xl lg:font-bold">ホーム</span></a></li>
<li><a class="flex flex-col items-center justify-center w-12 h-12 hover:bg-cax-brand-soft rounded-full sm:px-2 sm:w-24 sm:h-auto sm:rounded-sm lg:flex-row lg:justify-start lg:px-4 lg:py-2 lg:w-auto lg:h-auto lg:rounded-full" href="/search"><span class="relative text-xl lg:pr-2 lg:text-3xl"><svg class="font-awesome inline-block fill-current leading-none"><use href="/sprites/font-awesome/solid.svg#search"></use></svg></span><span class="hidden sm:inline sm:text-sm lg:text-xl lg:font-bold">検索</span></a></li>
<li><button class="hover:bg-cax-brand-soft flex h-12 w-12 flex-col items-center justify-center rounded-full sm:h-auto sm:w-24 sm:rounded-sm sm:px-2 lg:h-auto lg:w-auto lg:flex-row lg:justify-start lg:rounded-full lg:px-4 lg:py-2" type="button"><span class="relative text-xl lg:pr-2 lg:text-3xl"><svg class="font-awesome inline-block fill-current leading-none"><use href="/sprites/font-awesome/solid.svg#sign-in-alt"></use></svg></span><span class="hidden sm:inline sm:text-sm lg:text-xl lg:font-bold">サインイン</span></button></li>
<li><a class="flex flex-col items-center justify-center w-12 h-12 hover:bg-cax-brand-soft rounded-full sm:px-2 sm:w-24 sm:h-auto sm:rounded-sm lg:flex-row lg:justify-start lg:px-4 lg:py-2 lg:w-auto lg:h-auto lg:rounded-full text-cax-brand" href="/terms"><span class="relative text-xl lg:pr-2 lg:text-3xl"><svg class="font-awesome inline-block fill-current leading-none"><use href="/sprites/font-awesome/solid.svg#balance-scale"></use></svg></span><span class="hidden sm:inline sm:text-sm lg:text-xl lg:font-bold">利用規約</span></a></li>
</ul>
</div>
</nav>
</aside>
<main class="relative z-0 w-screen max-w-screen-sm min-w-0 shrink pb-12 lg:pb-0">
<article class="px-2 pb-16 leading-relaxed md:px-4 md:pt-2">
...
<ol class="list-decimal pl-8"><li>本規約の解釈にあたっては、日本法を準拠法とします。</li><li>本サービスに関して紛争が生じた場合には、当社の本店所在地を管轄する裁判所を専属的合意管轄とします。</li></ol>
...
staticRouter.use(async (req, res, next) => {
  ...
  // /terms is fully static HTML (no React bundle) for zero TBT
  if (urlPath === "/terms") {
    const html = getTermsStaticHtml();
