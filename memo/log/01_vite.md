...
https://github.com/CyberAgentHack/web-speed-hackathon-2026/issues/52#issuecomment-4094895492
...
合計 **238.90 / 1150 点** （ユーザーフローは300点未満のためスキップ）

| ページ | CLS (25) | FCP (10) | LCP (25) | SI (10) | TBT (30) | 合計 |
|---|---|---|---|---|---|---|
| ホーム | 18.50 | 0.00 | 0.00 | 0.00 | 0.00 | 18.50 |
| 投稿詳細 | 25.00 | 0.00 | 0.00 | 0.00 | 1.20 | 26.20 |
| 写真投稿詳細 | 24.75 | 0.00 | 0.00 | 0.00 | 0.00 | 24.75 |
| 動画投稿詳細 | 23.75 | 0.00 | 0.00 | 0.00 | 0.00 | 23.75 |
| 音声投稿詳細 | 25.00 | 0.00 | 0.00 | 0.00 | 0.00 | 25.00 |
| 検索 | 25.00 | 0.00 | 0.00 | 0.00 | 0.30 | 25.30 |
| DM一覧 | 25.00 | 0.00 | 0.00 | 0.00 | 7.20 | 32.20 |
| DM詳細 | 25.00 | 0.00 | 0.00 | 0.00 | 6.00 | 31.00 |
| 利用規約 | 25.00 | 0.00 | 0.00 | 0.00 | 7.20 | 32.20 |

### ボトルネック
- FCP / LCP / SI が全ページ 0 点 → 巨大 JS バンドル (12MB) が描画をブロック
- TBT も大部分 0 点 → メインスレッドブロッキング深刻
- 次の改善: コード分割 (dynamic import)、バンドルサイズ削減、Tailwind ビルド時処理、フォント最適化
